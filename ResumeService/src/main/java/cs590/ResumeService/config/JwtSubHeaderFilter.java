 ...
 * validated subject and any client-supplied {@code X-User-Sub} is ignored — closing the spoofing
 * gap that existed while services trusted the header blindly. Only wired in when JWT auth is enabled.
 */
